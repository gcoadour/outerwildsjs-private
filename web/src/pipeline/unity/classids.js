// Table des identifiants de classe Unity -> nom.
// Extraite de l'enumeration publique des ClassID Unity ; aucune donnee du jeu.
...
export const CLASS_IDS = Object.fromEntries(
  Object.entries(CLASS_NAMES).map(([id, name]) => [name, Number(id)]));
